 ...
 * @author Shoaib
 */
public class emp_billing8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Chinese/Continental");

        strt.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Chicken Cashewnut", "Basil Fried Rice", "Peking Chowmein", "Shahi Batair", "Bar B QPizza", "Manchrian" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Main", "Mumbai Biryani", "Kashmiri Mutton Karahi", "Indain Smoke Chicken", "Channa Curry", "Aloo Bhujia", "Suji ka Halwa", "Mutton Kunna" }));
        ...
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Deserts", "Gulab Jaman", "Jelly Mousse", "Tiramisu", "Punj Summer (Fruit Chaat)" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/lalqila_cover.png"))); // NOI18N
