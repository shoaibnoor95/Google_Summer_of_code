 ...
 * @author Shoaib
 */
public class emp_billing4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Starter", "Maxican wing ", "Musturd wing", "Cheasy Fries", "Lahore Fish", "Masala Friesl", "Soup" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Beef Boti", "Mutton Rise", "Shahi Handi", "Chineese Fried Rise", "Red Tiika", "BBQ Prawn", "KataKat" }));
        ...
        jLabel5.setText("Bevearages");

        dest.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bevages", "Pepsi", "Coke", "Sprite Diet", "Mineral Water" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/kababjees_cover.jpg"))); // NOI18N
