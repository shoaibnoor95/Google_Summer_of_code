 ...
 * @author Shoaib
 */
public class emp_billing5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Starter", "Red Pepper Dip", "Peri Drizzle", "Steak and Cheese", "3 Chicken Wings", "Peri Nuts" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Main", "1/4 Chicken Broast", "Wing Roulette", "Sunset Burger", "Berry Burger", "Grilled Chicken", "Turkey Thign", "Chicken Thigh" }));
        ...
        jLabel5.setText("Drinks/Dessert");

        dest.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select extras", "Vanila", "Strawberry", "Chocolate", "Coke Zero" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/nandos_cover.jpg"))); // NOI18N
