 ...
 * @author Shoaib
 */
public class emp_billing12 extends javax.swing.JFrame {

    int sum;
    public emp_billing12() {
        initComponents();
        BILL=BILL+1;
       billid.setText(""+BILL);
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(60, 140, 140, 25);
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Appetizer", "Cheese Garlic Bread", "Garlic bread", "Cheesy Garlic Roll", "Mexican Sandwich", "Salad" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Falavor", "BBQ ", "Malai Boti", "Italian Delight", "Fajita Sensation", "Beef Sensation", "Spicy Italian", "Veggie" }));
        ...
        jLabel5.setText("Softdrink/Mineral Water");

        dest.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Beverage", "250 ml", "500 ml", "Water/Large", "Water/Small", " " }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/o-my-pizza-karachi_cover.png"))); // NOI18N
        getContentPane().add(jLabel9);
        jLabel9.setBounds(0, -40, 730, 710);
