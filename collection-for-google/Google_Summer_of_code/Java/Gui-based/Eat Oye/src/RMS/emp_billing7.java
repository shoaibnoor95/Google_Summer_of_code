 ...
 * @author Shoaib
 */
public class emp_billing7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Roll", "Mayo Garlic Roll", "Beef Roll", "Chicken Roll", "Apple Roll (Special)", "Arabian Roll" }));
        ...
        jLabel4.setText("Bar Bee Que");

        main.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select BBQ", "Malai Boti", "Behari Boti", "Behari Kabab", "Dhaga Kabab", "Fish Boti", "Afghani Tikka", "Lebnani Kabab" }));
        ...
        jLabel5.setText("With Chineese Rice");

        dest.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Chineese", "Beef Bread", "Fish Shashlik", "Fish Chilli Dry", "Chicken Lime" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/redapple_cover.jpg"))); // NOI18N
