 ...
 * @author Shoaib
 */
public class emp_billing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Starter", "Italian BMT Salad", "Roasted Chicken Salad", "Roast Beef Salad", "Steak and Cheese", "Subway club Salad", "Subway Melt Salad" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Sandwich", "Italian BMT", "Roasted Chicken", "Roasted Beef", "Steak & Cheese", "Subway club", "Turkey Thign", "Subway Melt" }));
        ...
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select extras", "Chips", "Cookies", "Drink", "Coffee" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/subway_cover.jpg"))); // NOI18N
