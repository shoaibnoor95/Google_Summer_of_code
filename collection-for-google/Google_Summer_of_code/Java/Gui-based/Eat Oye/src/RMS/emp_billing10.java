 ...
 * @author Shoaib
 */
public class emp_billing10 extends javax.swing.JFrame {

    int sum;
    public emp_billing10() {
        initComponents();
        BILL=BILL+1;
       billid.setText(""+BILL);
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Starter", "Spicy wedges", "Garlic bread", "BBQ chicken roll", "Behari chicken roll", "Trio platter" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select ", "Super Supreme", "Fajita Sicilian", "Meatball Madness", "Tropical Hawaian", "Margherita", "Cheeky Chicken", "Very Veggie" }));
        ...
        jLabel5.setText("Deserts");

        dest.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Deserts", "Hershev`s cookies", "Double chip cookies", "Chocolate lava cake", "Ice cream" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/Pizza hut_cover.png"))); // NOI18N
