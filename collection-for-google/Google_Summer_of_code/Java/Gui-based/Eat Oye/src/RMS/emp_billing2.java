 ...
 * @author Shoaib
 */
public class emp_billing2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Starter", "Cheese Ball", "Nuggets", "Lime", "Cocktail", "Roasted Meal", "Suaceage Muffin" }));
        ...
        jLabel4.setText("Main Cuisine");

        main.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Main", "Twister", "Zinger", "Hotshots (9pcs)", "Beef Burger", "Spice Rice", "Krunch Burger", "Chicken Burger with cheese" }));
        ...
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Drink/Beverages", "Mineral Water", "Coca cola", "Pepsi", "Sprite" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/kfc_cover.jpg"))); // NOI18N
