 ...
 * @author Shoaib
 */
public class emp_billing13 extends javax.swing.JFrame {

    int sum;
    public emp_billing13() {
        initComponents();
        BILL=BILL+1;
       billid.setText(""+BILL);
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Starter", "Garlic Bread", "Bread Stick", "Pasta", "Cripy Fries", "Salad" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Falavor", "Supreme Pizza", "Cheese Pizza", "Chicken Tikka", "Chicken Fajita ", "Beef Sensation", "Spicy Italian", "Veggie" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/california_cover.jpg"))); // NOI18N
