 ...
 * @author Shoaib
 */
public class emp_billing11 extends javax.swing.JFrame {

    int sum;
    public emp_billing11() {
        initComponents();
        BILL=BILL+1;
       billid.setText(""+BILL);
    ...
    private void initComponents() {
        ...
        strt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Appetizer", "Spicy wedges", "Garlic bread", "BBQ chicken roll", "Behari chicken roll", "Trio platter" }));
        ...
        main.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select ", "Dancing Fajita", "Wicked Blend", "Choros Spice", "Poppin BBQ", "Gypsy Euro", "All Vegie", "Mughal Beast" }));
        ...
        dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Sandwich", "Cheddar Mashroom", "Hot Buffalo", "Chicken roatten", "Beverages" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RMS/broadway_cover.jpg"))); // NOI18N
