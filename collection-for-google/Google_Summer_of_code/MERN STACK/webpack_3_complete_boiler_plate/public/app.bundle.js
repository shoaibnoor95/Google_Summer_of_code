...
var _MuiThemeProvider = __webpack_require__(204);
...
var _logout = __webpack_require__(295);
...
var Login = function (_Component) {
    ...
    _createClass(Login, [{
        key: 'handleChange',
        value: function handleChange(property, e) {
        ...
        value: function handleSubmit(e) {
            ...
            (0, _axios2.default)({ url: '/login',
                data: this.state.text,
                method: 'post',
                withCredentials: true
            }).then(function (data) {
                console.log(data);
                if (data.data.success) _History2.default.push('/dashboard');
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { type: 'text', name: 'username', onChange: this.handleChange.bind(this, "username"), value: this.state.text.username }),
                _react2.default.createElement('br', null),
                _react2.default.createElement('input', { type: 'password', name: 'password', onChange: this.handleChange.bind(this, "password"), value: this.state.text.password }),
                _react2.default.createElement('br', null),
                _react2.default.createElement(
                    'button',
...
var _getMuiTheme = __webpack_require__(245);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(49)(Function.call, __webpack_require__(110).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _lightBaseTheme = __webpack_require__(258);

var _lightBaseTheme2 = _interopRequireDefault(_lightBaseTheme);

var _zIndex = __webpack_require__(260);

var _zIndex2 = _interopRequireDefault(_zIndex);

var _autoprefixer = __webpack_require__(261);

var _autoprefixer2 = _interopRequireDefault(_autoprefixer);

var _callOnce = __webpack_require__(286);

var _callOnce2 = _interopRequireDefault(_callOnce);

var _rtl = __webpack_require__(287);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29), __webpack_require__(257)(module)))
...
var _createPrefixer = __webpack_require__(262);

var _createPrefixer2 = _interopRequireDefault(_createPrefixer);

var _createPrefixer3 = __webpack_require__(264);

var _createPrefixer4 = _interopRequireDefault(_createPrefixer3);

var _autoprefixerDynamic = __webpack_require__(269);

var _autoprefixerDynamic2 = _interopRequireDefault(_autoprefixerDynamic);

var _autoprefixerStatic = __webpack_require__(278);
...
var _prefixProperty = __webpack_require__(263);

var _prefixProperty2 = _interopRequireDefault(_prefixProperty);

var _prefixValue = __webpack_require__(112);

var _prefixValue2 = _interopRequireDefault(_prefixValue);

var _addNewValuesOnly = __webpack_require__(113);
...
var _calc = __webpack_require__(270);

var _calc2 = _interopRequireDefault(_calc);

var _flex = __webpack_require__(271);

var _flex2 = _interopRequireDefault(_flex);

var _flexboxIE = __webpack_require__(272);

var _flexboxIE2 = _interopRequireDefault(_flexboxIE);

var _flexboxOld = __webpack_require__(273);

var _flexboxOld2 = _interopRequireDefault(_flexboxOld);

var _gradient = __webpack_require__(274);
...
var _getPrefixedValue = __webpack_require__(18);
...
var _hyphenateProperty = __webpack_require__(115);
...
var _calc = __webpack_require__(279);

var _calc2 = _interopRequireDefault(_calc);

var _flex = __webpack_require__(280);
...
var _gradient = __webpack_require__(283);

var _gradient2 = _interopRequireDefault(_gradient);

var _sizing = __webpack_require__(284);
    ...
    _createClass(Signup, [{
        ...
        value: function handleSubmit(e) {
            ...
            (0, _axios2.default)({
                ...
                if (data.data.user) {
                    ...
                    _this2.state.text.error = data.data.message;
                }
            }).catch(function (err) {
                _this2.state.text.error = err.message;
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'password', name: 'password', onChange: this.handleChange.bind(this, "password"), value: this.state.text.password }),
                _react2.default.createElement('br', null),
                _react2.default.createElement('input', { type: 'text', name: 'phoneNubmer', onChange: this.handleChange.bind(this, "phoneNumber"), value: this.state.text.phoneNumber }),
                _react2.default.createElement('br', null),
                _react2.default.createElement('input', { type: 'text', name: 'displayName', onChange: this.handleChange.bind(this, "displayName"), value: this.state.text.displayName }),
                _react2.default.createElement('br', null),
                _react2.default.createElement('input', { type: 'text', name: 'email', onChange: this.handleChange.bind(this, "email"), value: this.state.text.email }),
                _react2.default.createElement('br', null),
                _react2.default.createElement(
                    'button',
                    { type: 'button', onClick: this.handleSubmit.bind(this) },
